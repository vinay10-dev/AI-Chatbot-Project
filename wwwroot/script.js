...
window.onbeforeunload = function () {
    // Window close ya reload hone se pehle server ko signal bhejna
    navigator.sendBeacon('/api/chat/reset-session?userId=' + currentUserId);
};
